...
this.data.forEach((e:any) => {
  ...
  dog_id       :      e.dog_id  ,
  dog_name            :      e.dog_name,
  form_status               :     this.form_status(e.form_status) ,
      q_1       : this.answer(e.q_1),
    q_2       : this.otheranswer(e.q_2),
    q_3       : this.otheranswer(e.q_3),
    q_4       : e.q_4,
    q_5       : this.otheranswer(e.q_5),
    q_6       : e.q_6,
    q_7       : this.fanswer(e.q_7),
    q_8       : e.q_8,
    q_9       : e.q_9,
    q_10      : e.q_10,
    q_11      : e.q_11,
    ...
    workbook.xlsx.writeBuffer().then((data) => {
      ...
      fs.saveAs(blob, 'form.xlsx');
    })

  }
  form_status(status:any){
    let semantic
    switch (status) {
      case 0:
        semantic='ລໍຖ້າ'
